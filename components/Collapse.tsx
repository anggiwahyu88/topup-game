...
const Collapse: React.FC = () => {
    return (
        <Link href="/game/mobile-legends" className="rounded-xl bg-[url(/bg-2.webp)] bg-cover bg-no-repeat bg-center w-full flex mx-auto items-center p-1.5 cursor-pointer ring-primary ring-offset-[-2px] hover:ring-offset-2 hover:scale-[1.015] ring-offset-dark ring-2 transition-all">
